...
parser.add_argument("--dataset", type=str, choices=["mosi", "mosei", "ets", "ets_female", "ets_male"], default="ets", help="Pickle (.pkl) file saved in ./dataset folder in { train: {(), }, test: {...}, dev (optional): {...}} format")
