...
parser.add_argument("--dev_batch_size", type=int, default=128, help="Batch size for dev/eval")
...
parser.add_argument("--save_model_every_epoch", type=str2bool, default="true", help="Save model every epoch")
parser.add_argument("--output_dir", type=str, default="mag-bert-base-uncased", help="Output directory where the model will be saved")
parser.add_argument("--learning_rate_adversary", type=float, default=1e-5, help="Learning rate for the adversary")
parser.add_argument("--pretrain_steps", type=int, default=3, help="Number of steps to pretrain the learner, -1 means no pretraining")
...
parser.add_argument("--early_stopping_patience", type=int, default=5, help="Number of steps until there is no improvement in validation loss")
