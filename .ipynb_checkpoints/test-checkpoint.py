...
parser.add_argument("--dataset", type=str, choices=["mosi", "mosei", "ets", "fiv2"], default="ets", help="Pickle (.pkl) file saved in ./dataset folder in { train: {(), }, test: {...}, dev (optional): {...}} format")
